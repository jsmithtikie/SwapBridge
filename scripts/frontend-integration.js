 ...
 * This file demonstrates how to integrate Swapbridge with a web frontend
 */

// For React/Vue/Angular applications
export class SwapbridgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SwapbridgeClient(provider, contractAddress);
